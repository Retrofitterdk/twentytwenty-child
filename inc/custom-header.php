 ...
 */
function twentytwenty_child_custom_header_setup() {
	...
	add_theme_support(
		 ...
		 */
		apply_filters(
			'twentytwenty_child_custom_header_args',
			array(
				...
				'flex-height'      => true,
				'video'            => true,
				// 'wp-head-callback' => 'twentytwenty_child_header_style',
			)
		)
	);
...
add_action( 'after_setup_theme', 'twentytwenty_child_custom_header_setup' );

if ( ! function_exists( 'twentytwenty_child_header_style' ) ) :
	/**
	 * Styles the header image and text displayed on the blog.
	 *
	 * @see twentyseventeen_custom_header_setup().
	 */
	function twentytwenty_child_header_style() {
 ...
 */
function twentytwenty_child_video_controls( $settings ) {
...
// add_filter( 'header_video_settings', 'twentytwenty_child_video_controls' );
